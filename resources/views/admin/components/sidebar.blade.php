      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{route('report.import.index')}}"> Báo cáo nhập hàng </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('report.sale.index')}}"> Báo cáo bán hàng </a></li>
